...
run_coding_task_with_timing 'Hallo lieber Chatbot. Bitte gib mir freundliche Tipps, wie man die nachfolgende (und echt komplizierte) Funktion refactoren kann:
...
run_coding_task_with_timing 'Tolles Ergebnis, vielen Dank!' "Dankeschön für Code-Refactoring."

# Task: Code Quality (Code Review)
run_coding_task_with_timing 'You are an experienced software engineer and my coding mentor. Please perform a thorough code review and tell me what to improve without giving me a complete solution. Thanks in advance!
...
run_coding_task_with_timing 'Vielen Dank für deine Hilfe, das hat sehr geholfen!' "Dankeschön für Code-Quality (Code Review)."

# Task: Documentation
run_coding_task_with_timing 'Bitte kommentiere den Code. Bitte ein Block-Kommentar je Funktion, bitte, sowie in-line Kommentare bei besonders komplizierten Stellen. Vermeide Kommentare, die nur erklären, was sowieso aus dem Code ersichtlich ist.
...
run_coding_task_with_timing 'Merci!' "Dankeschön für Dokumentation."

# Task: Find Bugs
run_coding_task_with_timing 'Mist! Ich bekomme Compile-Fehler bei dem folgenden Code. Außerdem stimmt die Funktionalität noch nicht. Bitte überarbeite den Code für mich
...
run_coding_task_with_timing 'Wow, du bist echt gut! Danke!' "Dankeschön für Find Bugs."

# Task: Explain Code
run_coding_task_with_timing 'Ich verstehe gar nichts. Was passiert hier?
...
run_coding_task_with_timing 'Vielen Dank! Jetzt verstehe ich es!' "Dankeschön für Explain Code (Kotlin infix)."
...
run_coding_task_with_timing 'Vielen Dank! Jetzt verstehe ich es!' "Dankeschön für Explain Code (Kafka Processor)."

# Task: Simplify Code -> Java to Kotlin
run_coding_task_with_timing '
Kannst du mir bitte dieses File in Kotlin übersetzen. Bitte achte auf die Vorteile von Kotlin von lesbar und möglichst kompakten selbst sprechenden Code.
...
run_coding_task_with_timing 'Vielen Dank, du hast mir sehr geholfen <3' "Dankeschön für Simplify Code (Java to Kotlin)."

# Task: Generate code snippets
run_coding_task_with_timing 'Ich habe ein Problem. Bitte hilf mir, eine Methode zu implemeniteren, die prüft, ob ein gegebener Aufenthalt im Schengen-Raum gemäß der sogenannten 90/180-Regel zulässig ist.
...
run_coding_task_with_timing 'Wow, du bist echt gut. Danke dir!' "Dankeschön für Generate Code Snippets (Schengen Rule)."

# Task: Generate Code for less known programming languages
run_coding_task_with_timing '
Ich brauche dein Hilfe: Ich habe folgende API mit der ich mir berechnen kann wann ein Task carbon aware also mit so grünem Strom wie möglich asugeführt werden kann.
...
run_coding_task_with_timing 'Vielen Dank! Du hast mir massiv weitergeholfen, Kumpel!' "Dankeschön für Generate Code (Home Assistant)."

# Task: Software Architektur
run_coding_task_with_timing 'Bitte berate mich als erfahrener SW Architekt mit Betriebserfahrung.
...
Jetzt hat sich die Betriebsorganisation geändert und Releases sind sehr langsam und schwierig. Welche Optionen hat man, mit den Versionsnummern umzugehen?
 ...
 run_coding_task_with_timing 'Vielen Dank! Jetzt verstehe ich es!' "Dankeschön für Software Architecture Advice."

# Task: Complete Test
run_coding_task_with_timing 'Bitte hilf mir und vervollständige den BookingSystemTest.
...
run_coding_task_with_timing 'Wow, du bist echt hilfreich. Ohne dich hätte ich es nicht so schnell geschafft... :)' "Dankeschön für Complete Test (Kotlin/mockk)."
